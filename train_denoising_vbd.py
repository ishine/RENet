...
def train(rank, a, h):
    ...
    for epoch in range(max(0, last_epoch), a.training_epochs):
        ...
        for i, batch in enumerate(train_loader):
            ...
            # https://github.com/yxlu-0102/MP-SENet/issues/47: you may remove the loss_time for the last 1~3 epochs, which does not affect overall perceptual quality and can get a better PESQ score.
            # may be only used for VBD, which is ultra small-scaled and removing time-loss may make a difference.
            # whether remove loss_time or not, the model shows superior generalization ability.
...
def main():
    ...
    parser.add_argument('--checkpoint_path', default='cp_model_vbd')
