...
def train(rank, a, h):
    ...
    if cp_g is None or cp_do is None:
        ...
        # Filter out incompatible keys when loading generator state
        ...
        for key in model_state_dict.keys():
            if key in checkpoint_state_dict and model_state_dict[key].size() == checkpoint_state_dict[key].size():
        ...
        if rank == 0:
            ...
            print("Loaded compatible generator parameters from checkpoint")
    ...
    training_pairs, validation_pairs = get_dns_dataset_filelist(a.input_training_file, a.input_validation_file)
    ...
    train_loader = DataLoader(trainset, num_workers=h.num_workers, shuffle=False,
                              ...
                              drop_last=True)
    if rank == 0:
        validset = DNSDataset(validation_pairs, a.input_test_clean_wavs_dir, h.segment_size, h.sampling_rate,
            ...
            if rank == 0:
                ...
                if steps % a.stdout_interval == 0:
                    with torch.no_grad():
                        ...
                        # pha_error = phase_loss_fn(clean_pha, pha_g, clean_mag**3.333).item()
                ...
                if steps % a.validation_interval == 0 and steps != 0:
                    ...
                    with torch.no_grad():
                        for j, batch in enumerate(validation_loader):
                            ...
                            # val_pha_err_tot += phase_loss_fn(clean_pha, pha_g, clean_mag**3.333).item()
...
def main():
    ...
    parser.add_argument('--input_clean_wavs_dir', default='/root/autodl-tmp/DNS-Challenge/clean')
    parser.add_argument('--input_test_clean_wavs_dir', default='/root/autodl-tmp/DNS-Challenge/datasets/test_set/synthetic/no_reverb/clean')
    parser.add_argument('--input_training_file', default='DNS20_filelist/training.txt')
    parser.add_argument('--input_validation_file', default='DNS20_filelist/test.txt')
    parser.add_argument('--checkpoint_path', default='cp_model_dns')
