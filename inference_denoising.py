...
def main():
    ...
    parser.add_argument('--input_noisy_wavs_dir', default='/data/home/wangchengzhong/dtb/DNS-Challenge/datasets/test_set/synthetic/no_reverb/noisy_rn') # change this to your DNS non-reverb testset
    # /root/autodl-tmp/DNS-Challenge/datasets/test_set/synthetic/no_reverb/noisy_rn
    # /root/autodl-tmp/VBD_real/test/noisy
